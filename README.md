...
2. Run the MATLAB scripts for alloy generation and optimization.  
3. Use the Jupyter notebook for phase prediction and analysis.  

---

## Citation
If you use this code, please cite the article:  
Das, P., & Pandey, P. M. (2024). Multi-objective optimization and machine learning assisted design and synthesis of magnesium based novel non-equiatomic medium entropy alloy. Journal of Alloys and Compounds, 985, 174066. DOI: 10.1016/j.jallcom.2024.174066
